...
[assembly: ExportEffect(typeof(Kouch.App.Droid.TouchEffectAndroid), "TouchEffect")]
namespace Kouch.App.Droid
{
    public class TouchEffectAndroid : PlatformEffect
    {
        ...
        ImageCropper.TouchEffect libTouchEffect;
        bool capture;
        Func<double, double> fromPixels;
        int[] twoIntArray = new int[2];

        static Dictionary<Android.Views.View, TouchEffectAndroid> viewDictionary =
            new Dictionary<Android.Views.View, TouchEffectAndroid>();

        static Dictionary<int, TouchEffectAndroid> idToEffectDictionary =
            new Dictionary<int, TouchEffectAndroid>();
        ...
        protected override void OnAttached()
        {
            ...
            ImageCropper.TouchEffect touchEffect =
                (ImageCropper.TouchEffect)Element.Effects.
                    FirstOrDefault(e => e is ImageCropper.TouchEffect);
        ...
        {
            TouchEffectAndroid touchEffectHit = null;
        ...
        void FireEvent(TouchEffectAndroid touchEffect, int id, TouchActionType actionType, Point pointerLocation, bool isInContact)
        {
